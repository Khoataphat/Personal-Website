...
export function EditorialDossier() {
  ...
  const currentTheme = SECTION_THEMES[activeDossierTab] || SECTION_THEMES[0];
  const accentColor = currentTheme.accent;
  const secondaryColor = currentTheme.secondary || '#818cf8';
      ...
      >
        ...
        <div className="flex-shrink-0 border-b border-white/10 bg-black/50 pl-24 sm:pl-32 pr-5 sm:pr-8 py-3.5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <div className="font-mono text-xs tracking-widest" style={{ color: accentColor }}>
